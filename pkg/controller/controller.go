...
import (
	...
	networkcrdv1 "github.com/cuijxin/k8scrds/pkg/apis/networkcrd/v1"
	...
	networkscheme "github.com/cuijxin/k8scrds/pkg/generated/clientset/versioned/scheme"
	informers "github.com/cuijxin/k8scrds/pkg/generated/informers/externalversions/networkcrd/v1"
	listers "github.com/cuijxin/k8scrds/pkg/generated/listers/networkcrd/v1"
...
func NewController(
	...
	networkInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		...
		UpdateFunc: func(old, new interface{}) {
			oldNetwork := old.(*networkcrdv1.Network)
			newNetwork := new.(*networkcrdv1.Network)
