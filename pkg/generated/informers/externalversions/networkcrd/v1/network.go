...
import (
	...
	versioned "github.com/cuijxin/k8scrds/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/cuijxin/k8scrds/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/cuijxin/k8scrds/pkg/generated/listers/networkcrd/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkcrdV1().Networks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkcrdV1().Networks(namespace).Watch(context.TODO(), options)
			},
		},
		&networkcrdv1.Network{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkcrdv1.Network{}, f.defaultInformer)
}
